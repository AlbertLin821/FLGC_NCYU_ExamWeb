...
export const studentMessages = {
  'zh-TW': {
    ...
    result: {
      ...
      note: '系統會自動更新你的成績與評語。',
      loading: '正在讀取你的作答結果...',
      error: '無法取得作答結果，請稍後再試。',
      queueTitle: '恭喜你完成考試，AI 正在批改你的答案',
      queueRank: '目前排序：{{n}} / {{m}}',
      queuePending: '目前排隊中，請稍候。',
      queueGrading: '目前正在批改你的答案。',
      queueNoPosition: '已送入 AI 批改佇列，請稍候。',
      scoreLabel: '總分',
      currentStatus: '目前狀態',
      statusQueued: '排隊中',
      statusGrading: 'AI 批改中',
      statusDone: '批改已完成',
      statusPendingReview: '待人工複閱',
      examTitle: '考卷',
      submittedAt: '交卷時間',
      ...
      question: '第 {{n}} 題',
      ratio: '占比',
      waitingHint: '此頁會自動更新，直到 AI 批改完成。',
      backList: '返回考卷列表',
      home: '回到首頁',
    },
    exam: {
      ...
      pauseGrammarExtension: '偵測到文法外掛，考試已暫停',
  ...
  en: {
    ...
    result: {
      ...
      note: 'Your scores and feedback will update automatically here.',
      loading: 'Loading your exam results...',
      error: 'Could not load your exam results. Please try again later.',
      queueTitle: 'Your exam is complete. AI is grading your answers.',
      queueRank: 'Current queue position: {{n}} / {{m}}',
      queuePending: 'Your paper is waiting in the queue.',
      queueGrading: 'Your answers are being graded now.',
      queueNoPosition: 'Your answers are in the AI grading queue.',
      scoreLabel: 'Total Score',
      currentStatus: 'Current Status',
      statusQueued: 'Queued',
      statusGrading: 'AI grading',
      statusDone: 'Grading complete',
      statusPendingReview: 'Needs review',
      examTitle: 'Exam',
      submittedAt: 'Submitted at',
      overallFeedback: 'Overall Feedback',
      answerFeedback: 'Question Feedback',
      question: 'Question {{n}}',
      ratio: 'Ratio',
      waitingHint: 'This page refreshes automatically until grading is complete.',
    ...
    exam: {
      ...
      pauseGrammarExtension: 'A grammar extension was detected. The exam has been paused.',
